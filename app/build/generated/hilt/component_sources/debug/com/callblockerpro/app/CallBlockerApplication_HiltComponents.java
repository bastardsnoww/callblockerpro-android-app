...
import com.callblockerpro.app.di.CallLogModule;
import com.callblockerpro.app.di.DatabaseModule;
import com.callblockerpro.app.di.DomainModule;
import com.callblockerpro.app.di.PreferenceModule;
import com.callblockerpro.app.di.RemoteConfigModule;
import com.callblockerpro.app.di.RepositoryModule;
import com.callblockerpro.app.di.SchedulerModule;
import com.callblockerpro.app.di.ServiceModule;
...
public final class CallBlockerApplication_HiltComponents {
  private CallBlockerApplication_HiltComponents() {
  }
  ...
  @Component(
      modules = {
          ...
          SchedulerWorker_HiltModule.class,
          ServiceModule.class
      }
  )
  @Singleton
  public abstract static class SingletonC implements CallBlockerApplication_GeneratedInjector,
  ...
  @Subcomponent
  @ServiceScoped
  public abstract static class ServiceC implements CallBlockingService_GeneratedInjector,
      ServiceComponent,
      GeneratedComponent {
